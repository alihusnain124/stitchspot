...
<section class="relative overflow-hidden bg-[#111]" style="min-height:280px">
   ...
   <div class="relative z-10 flex flex-col items-center justify-center text-center px-6 py-16" style="min-height:280px">
      <p class="font-body text-[10px] tracking-[5px] uppercase text-gold mb-3">Search Results</p>
...
<div class="max-w-[1340px] mx-auto px-4 lg:px-8">
   ...
   <div class="flex gap-8">
      ...
      <aside id="filter-panel"
         ...
         <form method="GET" action="{{ url('/search') }}" id="filter-form" class="p-5 lg:p-0">
            <input type="hidden" name="search_val" value="{{ $filters['search'] }}">
            ...
            <div class="flex items-center justify-between mb-5">
               ...
               <a href="{{ url('/search').'?'.http_build_query(['search_val' => $filters['search']]) }}" class="font-body text-[11px] text-[#E63946] hover:underline">Clear All</a>
            </div>
            @endif
      ...
      <div class="flex-1 min-w-0">
         ...
         <div class="hidden lg:flex items-center justify-between mb-7 flex-wrap gap-3">
            <p class="font-body text-[13px] text-gray-500">
               ...
               @if($filters['search'])
                  for <strong class="text-[#1A1A1A]">"{{ $filters['search'] }}"</strong>
               @endif
            </p>
            {{-- Active chips --}}
            <div class="flex flex-wrap gap-2">
               @foreach($filter_brands as $b)
                  ...
                  <a href="{{ url('/search').'?'.http_build_query($p) }}"
         ...
         <div class="text-center py-20">
            ...
            <p class="font-body text-[14px] text-gray-400 mb-6">Try adjusting your search or filters.</p>
...
function loadMore() {
   ...
   fetch('/search/more?' + params.toString())
